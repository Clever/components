...
function DefaultIcon() {
  return (<svg className="FileInput--Icon" width="42px" height="24px" viewBox="0 0 42 24">
    <g>
      <g transform="translate(-242.000000, -13.000000)" fill="#566279">
...
function UploadingIcon(props) {
  return (<svg className="FileInput--Icon" width="42px" height="24px" viewBox="0 0 42 24">
    <linearGradient id="bg" x1="0.5" y1="1" x2="0.5" y2="0">
      <stop offset="0%" stopOpacity="1" stopColor="#4274f6" />
      <stop offset={`${props.percent}%`} stopOpacity="1" stopColor="#4274f6" />
      <stop offset={`${props.percent}%`} stopOpacity="1" stopColor="#E3E6EB" />
      <stop offset="100%" stopOpacity="1" stopColor="#E3E6EB" />
    </linearGradient>
    <g>

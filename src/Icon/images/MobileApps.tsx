  ...
  return (
    <svg width="46px" height="46px" viewBox="0 0 46 46" version="1.1" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <g id="Artboards" stroke="none" strokeWidth={1} fill="none" fill-rule="evenodd">
        <g id="mobile-apps">
          <use id="Rectangle-2" stroke="#62748C" mask="url(#mask-2)" strokeWidth={4} fill="#FFFFFF" xlinkHref="#path-1" />
          <use id="Rectangle-2" stroke="#62748C" mask="url(#mask-4)" strokeWidth={4} xlinkHref="#path-3" />

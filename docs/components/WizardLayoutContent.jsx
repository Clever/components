...
const portalURL = (
  <FlexBox>
    ...
    <FlexBox column>
      <p>
        Update the link with a short URL, like your district's name, so students and teachers can easily access
         all their leaning applications from their portal.
          </p>
      <br />
      <FlexBox alignItems={ItemAlign.BASELINE} style={{color: "#474C5E"}}>
        <span style={{marginRight: -12}}>https://clever.com/in/</span>
        <TextInput style={{color: "#474C5E", border: "0.0625rem solid #e3e6eb"}} readOnly name="shortname" value="somedistrict" />
      </FlexBox>
    </FlexBox>
  </FlexBox>
);
...
const cleverSSO = (
  <FlexBox column>
    ...
    <p>
      ...
      districts' students and teachers secure one-click access into all of their online
      learning programs.
        </p>
    <div>
      <FlexBox>
        <Icon size={Icon.sizes.SMALL} name={Icon.names.CHECKMARK} /> Use existing accounts from Google,
          Microsoft 365, and other IDPs to log in
          </FlexBox>
      <FlexBox>
        <Icon size={Icon.sizes.SMALL} name={Icon.names.CHECKMARK} /> Give students access to a secure, personalized Portal
          </FlexBox>
      <FlexBox>
        <Icon size={Icon.sizes.SMALL} name={Icon.names.CHECKMARK} /> Get direct logins into Chromebooks and Windows devices
          </FlexBox>
    </div>
    <br />
    <p>
      Best yet, it only takes less than 10 minutes to set up and is available at no cost!
        </p>
    <br />
    <Button
...
const cleverGoals = (
  <FlexBox column>
    ...
    <p>
      Goals turns learning software into student achievement
        </p>
    <div>
      <FlexBox>
      ...
      <FlexBox>
        <Icon size={Icon.sizes.SMALL} name={Icon.names.CHECKMARK} />Improve learning outcomes
          </FlexBox>
    </div>
    <br />
    <Button

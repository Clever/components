        ...
        <Row grow className="margin--bottom--xl">
          <Col span={6} className="flexbox self--center padding--right--xl">
            <div>
              ...
              <p>
                Dewey is our source of truth for UI and product design at Clever. Everyone working at Clever
                is encouraged to stay familiar with this design system and help ensure that it is kept up-to-date.
              </p>
            </div>
          </Col>
        ...
        <Row grow>
          <Col span={6} className="flexbox padding--right--l">
            <div>
              ...
              <p>
                While it is highly recommended to use React for any new feature development or enhancement,
          ...
          <Col span={6} className="flexbox padding--right--l">
            <div>
              ...
              <p>
                Great question! If you're building a brand new component, check in with the #frontend slack
                channel to start the conversation. If you're improving an existing component or LESS file, just
                use the standard PR practice and <span className="text--italic">pick a frontend for PR</span>.
              </p>
            </div>
          </Col>
          <Col span={6} className="flexbox padding--right--l">
            <div>
              ...
              <p>
                If you can fix it quickly, go ahead and submit a quick bug fix PR. Otherwise, log a ticket in the
                {" "}
                <a
                  className="Button Button--linkPlain Button--regular"
          ...
          <Col span={6} className="flexbox padding--right--l">
            <div>
              ...
              <p>
                Alice Chipman Dewey and John Dewey were highly influential figures in education, philosophy, and social
                movements in the early 20<sup>th</sup> century. We pay homage to their work and influence on the fields
                of design, information systems, and education.
              </p>
            </div>
          </Col>
        </Row>

...
import {Drawer, FlexBox, ItemAlign, SegmentedControl} from "src";

import "./DrawerView.less";

const cssClass = {
  CONFIG_CONTAINER: "DrawerView--configContainer",
  CONFIG_OPTIONS: "DrawerView--configOptions",
  CONFIG: "DrawerView--config",
  CONFIG_TOGGLE: "DrawerView--configToggle",
  CONTAINER: "DrawerView",
  INTRO: "DrawerView--intro",
  ...
  render() {
    ...
    return (
      <View
        ...
        title="Drawer"
        sourcePath="src/Drawer/Drawer.tsx"
      >
        <header className={cssClass.INTRO}>
          ...
          <CodeSample>
            {`
              import {Drawer} from "clever-components";
            `}
          </CodeSample>
        </header>

  ...
  render() {
    ...
    return (
      <View className={cssClass.CONTAINER} title="Colors">
        <Grid>
          <Row grow className="items--start margin--bottom--5xl padding--right--m">
          ...
          <Row grow className="items--start margin--bottom--5xl">
            <Col span={5} className="flexbox justify--left items--center padding--right--l">
              <div className="display--block">
            ...
            <Col span={7} className="flexbox justify--left items--center">
              <Row grow>
                <Col span={4} className="flexbox justify--left margin--bottom--l">
          ...
          <Row grow className="items--start margin--bottom--5xl padding--right--m">
            ...
            <Col span={7} className="flexbox justify--left items--center">
              <Row grow>
                ...
                <Col span={2} className="flexbox justify--left">

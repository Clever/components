...
npx jscodeshift --dry-run --componentName="$NAME" -t ./addToSidebar.ts ../docs/components/SideBar/SideBar.jsx
../node_modules/.bin/prettier --write ../docs/components/SideBar/SideBar.jsx
npx jscodeshift --dry-run --componentName="$NAME" -t ./addRoute.ts ../docs/docs.jsx
../node_modules/.bin/prettier --write ../docs/docs.jsx
npx jscodeshift --dry-run --componentName="$NAME" -t ./addScreenshot.ts ../docs/components/ComponentsView.jsx

...
var ModalButton = exports.ModalButton = function (_React$Component) {
  ...
  _createClass(ModalButton, [{
    ...
    value: function render() {
      ...
      var buttonProps = (0, _utils.propsFor)(_Button.Button, this.props);
      var modalProps = (0, _utils.propsFor)(_Modal.Modal, (0, _utils.unprefixKeys)(this.props, "modal"));

      return _react2.default.createElement(
        "div",
        { className: (0, _classnames2.default)("ModalButton", this.props.className) },
        _react2.default.createElement(_Button.Button, _extends({}, buttonProps, { onClick: function onClick(e) {
...
var modalPropTypes = (0, _utils.prefixKeys)(_utils.omitKeys.apply(undefined, [_Modal.Modal.propTypes].concat(excludeModalProps)), "modal");

ModalButton.propTypes = _extends({}, _Button.Button.propTypes, modalPropTypes, {
  children: _Modal.Modal.propTypes.children,
...
ModalButton.defaultProps = _extends({}, _Button.Button.defaultProps, (0, _utils.prefixKeys)(_Modal.Modal.defaultProps, "modal"));
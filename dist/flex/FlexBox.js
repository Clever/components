...
FlexBox.propTypes = _extends({}, _FlexItem2.default.propTypes, {
  alignContent: _react.PropTypes.oneOf(_lodash2.default.values(_ContentAlign2.default)),
  alignItems: _react.PropTypes.oneOf(_lodash2.default.values(_ItemAlign2.default)),
  children: _react.PropTypes.node,
  className: _react.PropTypes.string,
  column: _react.PropTypes.bool,
  inline: _react.PropTypes.bool,
  justify: _react.PropTypes.oneOf(_lodash2.default.values(_Justify2.default)),
